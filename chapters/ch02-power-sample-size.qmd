...
The review by Serdar et al, “Sample size, power and effect size revisited: simplified and practical approaches in pre-clinical, clinical and laboratory studies” is very helpful. (https://doi.org/10.11613/BM.2021.010502).  Table 2 in the paper has notes on software performance, user friendliness, and if the software is free.
