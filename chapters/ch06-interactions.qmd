...
CR.data = data.frame(
  CR = c("Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes",
...
CR.Age.data = data.frame(
  ...
  Learning.score = c(65, 68, 72, 60, 69, 71, 62, 70,
                     64, 67, 62, 61, 68, 63, 64, 65),
  Age = c("Young", "Old", "Old", "Young", "Old", "Old", "Young", "Old",
          "Young", "Young", "Old", "Young", "Old", "Old", "Old", "Old"))

young.mouse.data = subset(CR.Age.data, Age=="Young")
old.mouse.data   = subset(CR.Age.data, Age=="Old")

mouse.lm.CR       = lm(Learning.score ~ CR, data=CR.data)
