...
The American Statistical Association (ASA) published a statement on p-values that outlined many of the issues:
...
[https://www.amstat.org/asa/files/pdfs/p-valuestatement.pdf](https://www.amstat.org/asa/files/pdfs/p-valuestatement.pdf) and 

[https://amstat.tandfonline.com/doi/full/10.1080/00031305.2016.1154108#.Vt2XIOaE2MN](https://amstat.tandfonline.com/doi/full/10.1080/00031305.2016.1154108).
...
Colleagues and students sometimes ask me, what p-value do I need to get to know that a treatment really works? My answer is that a p-value can’t tell you that. To really show that there is an effect, an independent group needs to replicate the results. For approval of a new drug in the United States, the Food and Drug Administration standard requirement is two independent clinical trials both showing a statistically significant result, with a sufficiently large effect size to be of clinical benefit.
