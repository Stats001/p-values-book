...
When a researcher wants to increase the chance of getting p < 0.05, the first thing he or she often thinks of is to increase the sample size. In this chapter, I'll show you why increasing the sample size should be the last thing you do. Reducing unexplained variability first is more effective and requires less work than increasing sample size. Let’s see why. 
...
Here are the p-values we get from taking the 4 samples from the same population:
...
data:  placebo.sample and drug.sample
t = 3.5152, df = 58, p-value = 0.0008599
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
  3.78224 13.78685
sample estimates:
...
After reducing the variability within group we get a good p-value, p = 0.00086, for this sample.
...
What percent of the 1000 simulated samples give a p-value less than 0.05? From the graph, approximately 960 out of 1000 simulated samples give p < 0.05. So, the probability that our experiment will give us a significant result is 960/1000, or 96%. The simulation indicates that we have 96% power.
